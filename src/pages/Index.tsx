...
const Index = () => {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-gradient-to-b from-primary to-primary/80 relative overflow-hidden">
        {/* SVG Background */}
        <div className="absolute inset-0 w-full h-[400%]" style={{ top: '-100%' }}>
          <img 
