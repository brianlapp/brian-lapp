      ...
      <main className="container mx-auto px-4 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-slate-900">Complete Business Email Solution</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                ...
                <h3 className="text-xl font-semibold mb-4 text-slate-900">Professional Email</h3>
              ...
              <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                ...
                <h3 className="text-xl font-semibold mb-4 text-slate-900">Business Tools</h3>
                <p className="text-slate-800">
              ...
              <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                ...
                <h3 className="text-xl font-semibold mb-4 text-slate-900">Work Anywhere</h3>
                <p className="text-slate-800">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-slate-900">Benefits for Your Business</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-slate-900">Look Professional</h3>
                    <p className="text-slate-800">Custom email addresses show customers you're an established business they can trust.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-slate-900">Reliable & Secure</h3>
                    <p className="text-slate-800">Enterprise-grade security and 99.9% uptime ensure your business communications never miss a beat.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-slate-900">Easy Team Collaboration</h3>
                    <p className="text-slate-800">Share documents, manage calendars, and coordinate with your team effortlessly.</p>
                  </div>
                </div>
              </div>
